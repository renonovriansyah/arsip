                            ...
                            <form action="{{ route('archives.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row g-0">
                                    ...
                                    <div class="col-md-7 p-4 p-lg-5 border-end">
                                        ...
                                        <div class="mb-3">
                                            <label class="form-label fw-bold small text-muted">Nomor Arsip / SK</label>
                                            <div class="input-group">
                                                <span class="input-group-text bg-light border-end-0"><i class="bi bi-hash"></i></span>
                                                <input type="text" name="nomor_arsip" class="form-control bg-light border-start-0 ps-0" placeholder="01/SK/BPK-JMB/2026" required>
                                            </div>
                                        </div>

                                        <div class="mb-3">
                                            <label class="form-label fw-bold small text-muted">Judul Peraturan</label>
                                            <textarea name="judul" class="form-control bg-light" rows="4" placeholder="Ketik judul lengkap..." required></textarea>
                                        </div>

                                        <div class="mb-3">
                                            <label class="form-label fw-bold small text-muted">Tahun Terbit</label>
                                            <input type="number" name="tahun" class="form-control bg-light w-50" placeholder="2026" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-5 p-4 p-lg-5 bg-light d-flex flex-column justify-content-center">
                                        ...
                                        <div class="upload-zone text-center p-4 rounded-4 position-relative">
                                            <i class="bi bi-cloud-arrow-up-fill display-4 text-primary opacity-25"></i>
                                            <h6 class="fw-bold mt-3 text-dark">Upload PDF</h6>
                                            <p class="text-muted small mb-3">Klik untuk memilih file dari komputer Anda.</p>
                                            
                                            <input type="file" name="file_arsip" class="form-control position-absolute top-0 start-0 h-100 opacity-0" accept=".pdf" required style="cursor: pointer;">
                                            
                                            <span class="badge bg-white text-secondary border shadow-sm py-2 px-3 rounded-pill">
                                                Pilih File
                                            </span>
                                        </div>
